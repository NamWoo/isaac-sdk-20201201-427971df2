...
def isaac_cc_module(
    ...
    default_deps = ["@com_nvidia_isaac//engine/alice", "@com_nvidia_isaac//engine/core", "//messages"]
...
def isaac_component(name, filename = None, deps = [], visibility = [], **kwargs):
    ...
    isaac_cc_library(
        ...
        hdrs = [filename + ".hpp"],
        visibility = visibility,
        deps = deps + ["@com_nvidia_isaac//engine/alice", "@com_nvidia_isaac//engine/core", "//messages"],
        **kwargs
    )
