...
// It takes another PlannerCost and simply adds a constant value to it.
class ScalarAddition : public PlannerCost {
 public:
  ScalarAddition() = default;
  ...
  // Sets the constant scalar to add.
