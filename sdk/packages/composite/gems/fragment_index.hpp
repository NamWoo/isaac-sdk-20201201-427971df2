...
class FragmentIndex {
 public:
  ...
  // Gets indices of all relevant elements in the source buffer
  void getSourceIndices(int* indices_ptr, int indices_count) const;

 private:
  // Locations of a bunch of elements in the source and in the target sequence
  struct Fragment {
