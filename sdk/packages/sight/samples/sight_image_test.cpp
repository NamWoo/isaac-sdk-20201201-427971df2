...
void UnrealImageToSight(alice::Application& app) {
  ...
  left->async_set_image_filename("../com_nvidia_isaac_engine/engine/gems/image/data/left.png");
  ...
  right->async_set_image_filename("../com_nvidia_isaac_engine/engine/gems/image/data/right.png");
  ...
  depth->async_set_image_filename("../com_nvidia_isaac_engine/engine/gems/image/data/depth.png");
  ...
  label->async_set_image_filename("../com_nvidia_isaac_engine/engine/gems/image/data/label.png");
  ...
  cloud3d->async_set_path("../com_nvidia_isaac_engine/engine/gems/image/data/");
  ...
  pinhole->async_set_path("../com_nvidia_isaac_engine/engine/gems/image/data/stairs.png");
