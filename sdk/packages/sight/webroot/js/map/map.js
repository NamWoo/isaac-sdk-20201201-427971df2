...
class IsaacMap {
  constructor(name, data) {
    ...
    const that = this;
    MapContainer().setEditingActionCallback(function() {
      if (MapContainer().isDrawingAction()) {
        that.layers_[that.active_layer_name_].startDrawing();
      } else {
        that.layers_[that.active_layer_name_].endDrawing();
      }
    });
  }
