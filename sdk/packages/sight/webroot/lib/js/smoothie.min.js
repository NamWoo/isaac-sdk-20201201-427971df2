...
0;for(0<this.data.length&&(a=Math.min(a,this.data[this.data.length-1][0]-2*b));this.data.length-e>=c&&this.data[e+1][0]<a;)e++;500<e&&this.data.splice(0,e)};l.prototype.startIndex=function(a){for(var c=this.data.length-1;0<=c&&this.data[c][0]>=a;)c--;return c+1};d.tooltipFormatter=function(a,c){a=[(this.options.timestampFormatter||d.timeFormatter)(new Date(a))];for(var b=0;b<c.length;++b)a.push('<span style="color:'+c[b].series.options.strokeStyle+'">'+this.options.yLabelFormatter(c[b].value,this.options.labels.precision)+
"</span>");return a.join("<br>")};d.defaultChartOptions={millisPerPixel:20,minHistoryMillis:3E5,enableDpiScaling:!0,yMinFormatter:function(a,c){return parseFloat(a).toFixed(c)},yMaxFormatter:function(a,c){return parseFloat(a).toFixed(c)},yLabelFormatter:function(a,c){return parseFloat(a).toFixed(c)},yIntermediateFormatter:function(a,c){return parseFloat(a).toFixed(c)},maxValueScale:1,minValueScale:1,interpolation:"linear",scaleSmoothing:.1,maxDataSetLength:2,scrollBackwards:!1,displayDataFromPercentile:1,grid:{fillStyle:"#000000",strokeStyle:"#777777",lineWidth:1,
