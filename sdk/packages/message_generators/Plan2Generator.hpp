...
// either listed as poses directly, or as names of the frames to look-up from the PoseTree. This
// codelet also publishes the last waypoint of the plan as goal message.
class Plan2Generator : public alice::Codelet {
 public:
  ...
  // Report success after publishing the plan
  ISAAC_PARAM(bool, report_success, false);
  // Whether or not to erase the path in sight when stopping
  ISAAC_PARAM(bool, erase_path_on_stop, true);
