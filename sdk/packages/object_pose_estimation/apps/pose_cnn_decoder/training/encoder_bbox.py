...
class EncoderBbox(object):
    ...
    def concat_latent_code(self):
        ...
        concat_latent_code = tf.concat(values=[self._encoder_image_latent_code, x], axis=1)
    ...
    def reg_loss(self):
        ...
        reg_loss = tf.reduce_mean(
            tf.abs(tf.norm(self._encoder_bbox_out, axis=1) - tf.constant(1.)))
        return reg_loss
